...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "\\javayh-mybatisplus\\src\\main\\java");
        gc.setAuthor("Dylan Yang");
        gc.setOpen(false);
        ...
        dsc.setPassword("1219320");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
//        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.javayh");
        ...
        // 如果模板引擎是 freemarker
        //String templatePath = "/templates/mapper.mapper.ftl";
        // 如果模板引擎是 velocity
...
//        strategy.setSuperEntityClass("com.javayh.entity.Pages");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
//        strategy.setSuperControllerClass("com.javayh.BaseController");
